...
const priorityAdminRoutes = require('./routes/priority-admin.routes')
...
app.use('/api/priority-admin', priorityAdminRoutes)
...
async function startServer() {
  ...
  app.listen(PORT, () => {
    ...
    // Auto-resync every 5 min (keep slots fresh without hammering the API)
